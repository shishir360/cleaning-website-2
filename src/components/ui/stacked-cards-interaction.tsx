...
return (
  <div
    className={cn(
      "w-[calc(100vw-3rem)] sm:w-[350px] max-w-[350px] cursor-pointer h-[400px] overflow-hidden bg-white rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.02)] border border-gray-200/80",
      className
    )}
  >
    {image && (
...
return (
  <div className="relative w-full h-full flex items-center justify-center overflow-x-hidden md:overflow-visible">
    <div className="relative w-[calc(100vw-3rem)] sm:w-[350px] max-w-[350px] h-[400px]">
